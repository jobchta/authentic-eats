...
const TrendingSection = () => {
  ...
  // Take the top 7 highest-rated dishes as "trending"
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center gap-3 mb-10">
          ...
          <p className="font-body text-muted-foreground text-sm">
            Highest-rated dishes from our database
          </p>
        </div>
      </div>

      <div
        className="flex gap-5 overflow-x-auto pb-4 px-4 snap-x snap-mandatory scrollbar-hide"
              ...
              >
                <div className="relative aspect-[3/4] rounded-xl overflow-hidden mb-3 bg-muted">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-6xl">{dish.country?.flag_emoji ?? "🍽️"}</span>
                  </div>
